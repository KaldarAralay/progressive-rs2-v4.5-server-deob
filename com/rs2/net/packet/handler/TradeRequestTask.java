...
public final class TradeRequestTask
extends TickTask {
    private final /* synthetic */ Player targetPlayer;
    private final /* synthetic */ Player requestingPlayer;
    private final /* synthetic */ int actionSequence;

    public TradeRequestTask(PlayerInteractionPacketHandler playerInteractionPacketHandler, int n, Player player, Player player2, int n2) {
        super(1);
