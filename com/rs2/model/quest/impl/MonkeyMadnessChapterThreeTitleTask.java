...
final class MonkeyMadnessChapterThreeTitleTask
extends TickTask {
    private /* synthetic */ MonkeyMadnessQuest a;
    private final /* synthetic */ Player b;

    MonkeyMadnessChapterThreeTitleTask(MonkeyMadnessQuest monkeyMadnessQuest, int n, Player player) {
    ...
    public final void execute() {
        ...
        this.b.moveTo(this.b.cutsceneReturnPosition);
        ...
        player2 = player;
        player2.packetSender.sendInterfaceText("@cya@Monkey Madness: Chapter 3", 3027);
        player2 = player;
        player2.packetSender.sendInterfaceText("", 3028);
        player2 = player;
        player2.packetSender.sendInterfaceText("", 3029);
        player2 = player;
        player2.packetSender.sendInterfaceText("@cya@In which our hero finds himself contending with life as a", 3030);
        player2 = player;
        player2.packetSender.sendInterfaceText("@cya@monkey.", 3031);
        player2 = player;
