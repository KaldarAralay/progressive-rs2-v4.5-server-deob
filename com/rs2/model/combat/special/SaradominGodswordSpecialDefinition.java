...
public final class SaradominGodswordSpecialDefinition
extends SpecialAttackDefinition {
    public SaradominGodswordSpecialDefinition(int n2, String ... stringArray) {
        super(n2, stringArray);
    }

    @Override
    public final WeaponCombatAttack createAttack(Player player, Entity entity, WeaponProfile weaponProfile) {
        return new SaradominGodswordSpecialAttack(this, player, entity, weaponProfile);
    }
}
