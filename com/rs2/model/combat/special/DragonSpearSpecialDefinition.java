...
final class DragonSpearSpecialDefinition
extends SpecialAttackDefinition {
    DragonSpearSpecialDefinition(int n2, String ... stringArray) {
    }

    @Override
    public final WeaponCombatAttack createAttack(Player object, Entity entity, WeaponProfile weaponProfile) {
        object = new DragonSpearSpecialAttack(this, (Player)object, entity, weaponProfile);
        return object;
    }
}
