...
final class DragonAxeSpecialDefinition
extends SpecialAttackDefinition {
    DragonAxeSpecialDefinition(int n2, String ... stringArray) {
    }

    @Override
    public final WeaponCombatAttack createAttack(Player object, Entity entity, WeaponProfile weaponProfile) {
        object = new DragonAxeSpecialAttack(this, (Player)object, entity, weaponProfile);
        return object;
    }
}
