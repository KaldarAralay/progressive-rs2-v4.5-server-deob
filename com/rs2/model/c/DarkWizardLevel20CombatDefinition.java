...
public final class DarkWizardLevel20CombatDefinition
extends NpcCombatDefinition {
    public DarkWizardLevel20CombatDefinition() {
    }

    @Override
    public final CombatAttack[] createAttacks(Entity entity, Entity entity2) {
        return new CombatAttack[]{BaseCombatAttack.createMagicAttack(entity, entity2, SpellDefinition.EARTH_STRIKE), BaseCombatAttack.createMagicAttack(entity, entity2, SpellDefinition.WEAKEN)};
    }
}
