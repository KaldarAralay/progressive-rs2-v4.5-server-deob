...
final class WallasalkiCombatDefinition
extends NpcCombatDefinition {
    WallasalkiCombatDefinition() {
    }

    @Override
    public final CombatAttack[] createAttacks(Entity entity, Entity entity2) {
        return new CombatAttack[]{BaseCombatAttack.createMagicAttack(entity, entity2, SpellDefinition.WALLASALKI_WATER_WAVE)};
    }
}
