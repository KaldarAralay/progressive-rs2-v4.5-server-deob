...
public final class AviansieRanged1191Max16CombatDefinition
extends NpcCombatDefinition {
    public AviansieRanged1191Max16CombatDefinition() {
    }

    @Override
    public final CombatAttack[] createAttacks(Entity entity, Entity entity2) {
        return new CombatAttack[]{BaseCombatAttack.createProjectileAttack(entity, entity2, CombatType.RANGED, AttackXpMode.LONGRANGE, 16, 4, 6953, new GraphicEffect(-1, 0), new GraphicEffect(-1, 0), 1191, ProjectileTiming.a)};
    }
}
