...
public final class WaterWizardCombatDefinition
extends NpcCombatDefinition {
    public WaterWizardCombatDefinition() {
    }

    @Override
    public final CombatAttack[] createAttacks(Entity entity, Entity entity2) {
        return new CombatAttack[]{BaseCombatAttack.createMagicAttack(entity, entity2, SpellDefinition.WATER_STRIKE), BaseCombatAttack.createMagicAttack(entity, entity2, SpellDefinition.WEAKEN)};
    }
}
