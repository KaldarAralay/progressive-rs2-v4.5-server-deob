...
public final class WizardCombatDefinition
extends NpcCombatDefinition {
    public WizardCombatDefinition() {
    }

    @Override
    public final CombatAttack[] createAttacks(Entity entity, Entity entity2) {
        return new CombatAttack[]{BaseCombatAttack.createMagicAttack(entity, entity2, SpellDefinition.WIZARD_FIRE_STRIKE)};
    }
}
