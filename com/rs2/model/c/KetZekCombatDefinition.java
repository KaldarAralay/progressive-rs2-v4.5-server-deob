...
final class KetZekCombatDefinition
extends NpcCombatDefinition {
    KetZekCombatDefinition() {
    }

    @Override
    public final CombatAttack[] createAttacks(Entity entity, Entity entity2) {
        return new CombatAttack[]{BaseCombatAttack.a(entity, entity2, AttackXpMode.MELEE_ACCURATE, AttackBonusType.STAB, 54, 4, 2644), BaseCombatAttack.a(entity, entity2, CombatType.MAGIC, AttackXpMode.MAGIC, 49, 4, 2647, new GraphicEffect(-1, 0), new GraphicEffect(446, 0), 445, ProjectileTiming.d)};
    }
}
