...
extends CycleEvent {
    ...
    public final void execute(CycleEventContainer cycleEventContainer) {
        ...
        if (!GameUtil.b(this.definition.getHarvestChanceLow(), this.definition.getHarvestChanceHigh(), HopsPatchManager.getPlayer(this.manager).getSkillManager().getCurrentLevels()[19])) {
