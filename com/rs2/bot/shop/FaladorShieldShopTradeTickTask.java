...
final class FaladorShieldShopTradeTickTask
extends TickTask {
    private final /* synthetic */ Player player;
    private final /* synthetic */ ItemStack shopItem;

    FaladorShieldShopTradeTickTask(FaladorShieldShopBotTask faladorShieldShopBotTask, int n, Player player, ItemStack itemStack) {
        this.player = player;
