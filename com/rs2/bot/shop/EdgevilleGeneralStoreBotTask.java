...
import com.rs2.bot.shop.EdgevilleGeneralStoreTradeTickTask;
...
public final class EdgevilleGeneralStoreBotTask
extends BotTaskDefinition {
    private static Position routeStartPosition = new Position(3096, 3494, 0);
    private static BotRoute[] taskRouteSegments = new BotRoute[]{new BotRoute(new Position[]{new Position(3092, 3500, 0), new Position(3080, 3506, 0)}), new BotRoute(new Position[]{new Position(3080, 3507, 0)})};

    public EdgevilleGeneralStoreBotTask(int n) {
        super(routeStartPosition, taskRouteSegments, 1, false, 1);
        n = 2;
        EdgevilleGeneralStoreBotTask edgevilleGeneralStoreBotTask = this;
    ...
    public final int getShopId() {
        NpcDefinition npcDefinition = NpcDefinition.forId(520);
    ...
    public final void configureTaskInteractionTargets(Player player) {
        ...
        player.botInteractionTargetIds.add(520);
        player.botInteractionTargetIds.add(521);
    }
    ...
    public final void startCustomTaskAction(Player object) {
        World.getTaskScheduler().schedule(new EdgevilleGeneralStoreTradeTickTask(this, 2, (Player)object));
    }
