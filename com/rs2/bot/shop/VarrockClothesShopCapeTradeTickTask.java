...
final class VarrockClothesShopCapeTradeTickTask
extends TickTask {
    private final /* synthetic */ Player player;
    private final /* synthetic */ ItemStack shopItem;

    VarrockClothesShopCapeTradeTickTask(VarrockClothesShopCapeBotTask varrockClothesShopCapeBotTask, int n, Player player, ItemStack itemStack) {
        this.player = player;
