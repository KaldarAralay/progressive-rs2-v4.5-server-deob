...
final class EdgevilleGeneralStoreTradeTickTask
extends TickTask {
    private final /* synthetic */ Player player;

    EdgevilleGeneralStoreTradeTickTask(EdgevilleGeneralStoreBotTask edgevilleGeneralStoreBotTask, int n, Player player) {
        this.player = player;
        super(2);
    }
