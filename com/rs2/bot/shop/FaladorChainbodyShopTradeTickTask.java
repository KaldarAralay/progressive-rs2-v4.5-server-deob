...
final class FaladorChainbodyShopTradeTickTask
extends TickTask {
    private final /* synthetic */ Player player;
    private final /* synthetic */ ItemStack shopItem;

    FaladorChainbodyShopTradeTickTask(FaladorChainbodyShopBotTask faladorChainbodyShopBotTask, int n, Player player, ItemStack itemStack) {
        this.player = player;
