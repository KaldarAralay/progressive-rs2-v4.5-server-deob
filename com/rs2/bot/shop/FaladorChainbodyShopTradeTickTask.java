...
public final class FaladorChainbodyShopTradeTickTask
extends TickTask {
    private final /* synthetic */ Player player;
    private final /* synthetic */ ItemStack shopItem;

    public FaladorChainbodyShopTradeTickTask(FaladorChainbodyShopBotTask faladorChainbodyShopBotTask, int n, Player player, ItemStack itemStack) {
        super(2);
        this.player = player;
