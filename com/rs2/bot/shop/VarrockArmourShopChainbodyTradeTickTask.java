...
final class VarrockArmourShopChainbodyTradeTickTask
extends TickTask {
    private final /* synthetic */ Player player;
    private final /* synthetic */ ItemStack shopItem;

    VarrockArmourShopChainbodyTradeTickTask(VarrockArmourShopChainbodyBotTask varrockArmourShopChainbodyBotTask, int n, Player player, ItemStack itemStack) {
        this.player = player;
