...
public final class VarrockArmourShopChainbodyTradeTickTask
extends TickTask {
    private final /* synthetic */ Player player;
    private final /* synthetic */ ItemStack shopItem;

    public VarrockArmourShopChainbodyTradeTickTask(VarrockArmourShopChainbodyBotTask varrockArmourShopChainbodyBotTask, int n, Player player, ItemStack itemStack) {
        super(2);
        this.player = player;
