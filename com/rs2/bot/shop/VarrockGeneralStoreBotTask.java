...
extends BotTaskDefinition {
    ...
    private static BotRoute[] ab = new BotRoute[]{new BotRoute(new Position[]{new Position(3253, 3428, 0), new Position(3239, 3428, 0), new Position(3227, 3428, 0), new Position(3227, 3428, 0), new Position(3217, 3420, 0)}), new BotRoute(new Position[]{new Position(3217, 3419, 0)})};

    public VarrockGeneralStoreBotTask(int n) {
    ...
    public final void startCustomTaskAction(Player object) {
        object = new VarrockGeneralStoreTradeTickTask(this, 2, (Player)object);
