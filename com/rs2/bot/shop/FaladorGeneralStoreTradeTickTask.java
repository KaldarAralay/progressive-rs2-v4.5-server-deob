...
final class FaladorGeneralStoreTradeTickTask
extends TickTask {
    private final /* synthetic */ Player player;

    FaladorGeneralStoreTradeTickTask(FaladorGeneralStoreBotTask faladorGeneralStoreBotTask, int n, Player player) {
        this.player = player;
        super(2);
    }
