...
final class VarrockStaffShopFireStaffTradeTickTask
extends TickTask {
    private final /* synthetic */ Player player;
    private final /* synthetic */ ItemStack shopItem;

    VarrockStaffShopFireStaffTradeTickTask(VarrockStaffShopFireStaffBotTask varrockStaffShopFireStaffBotTask, int n, Player player, ItemStack itemStack) {
        this.player = player;
