...
import com.rs2.bot.shop.PortSarimFishingShopTradeTickTask;
...
extends BotTaskDefinition {
    ...
    public final int getShopId() {
        NpcDefinition npcDefinition = NpcDefinition.forId(558);
    ...
    public final void configureTaskInteractionTargets(Player player) {
        ...
        player.botInteractionTargetIds.add(558);
    }
    ...
    public final void startCustomTaskAction(Player object) {
        ...
        World.getTaskScheduler().schedule(new PortSarimFishingShopTradeTickTask(this, 2, (Player)object, itemStack));
    }
