...
public final class VarrockRuneShopChaosRuneTradeTickTask
extends TickTask {
    private final /* synthetic */ Player player;
    private final /* synthetic */ ItemStack shopItem;

    public VarrockRuneShopChaosRuneTradeTickTask(VarrockRuneShopChaosRuneBotTask varrockRuneShopChaosRuneBotTask, int n, Player player, ItemStack itemStack) {
        super(2);
        this.player = player;
