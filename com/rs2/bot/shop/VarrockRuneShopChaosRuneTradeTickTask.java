...
final class VarrockRuneShopChaosRuneTradeTickTask
extends TickTask {
    private final /* synthetic */ Player player;
    private final /* synthetic */ ItemStack shopItem;

    VarrockRuneShopChaosRuneTradeTickTask(VarrockRuneShopChaosRuneBotTask varrockRuneShopChaosRuneBotTask, int n, Player player, ItemStack itemStack) {
        this.player = player;
