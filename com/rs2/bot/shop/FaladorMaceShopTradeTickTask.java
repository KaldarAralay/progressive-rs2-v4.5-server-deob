...
public final class FaladorMaceShopTradeTickTask
extends TickTask {
    private final /* synthetic */ Player player;
    private final /* synthetic */ ItemStack shopItem;

    public FaladorMaceShopTradeTickTask(FaladorMaceShopBotTask faladorMaceShopBotTask, int n, Player player, ItemStack itemStack) {
        super(2);
        this.player = player;
