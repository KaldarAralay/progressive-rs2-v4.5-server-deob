...
final class FaladorMaceShopTradeTickTask
extends TickTask {
    private final /* synthetic */ Player player;
    private final /* synthetic */ ItemStack shopItem;

    FaladorMaceShopTradeTickTask(FaladorMaceShopBotTask faladorMaceShopBotTask, int n, Player player, ItemStack itemStack) {
        this.player = player;
