...
import com.rs2.bot.shop.AlKharidGeneralStoreTradeTickTask;
...
public final class AlKharidGeneralStoreBotTask
extends BotTaskDefinition {
    private static Position routeStartPosition = new Position(3269, 3167, 0);
    private static BotRoute[] taskRouteSegments = new BotRoute[]{new BotRoute(new Position[]{new Position(3273, 3167, 0), new Position(3280, 3179, 0), new Position(3293, 3179, 0), new Position(3305, 3179, 0), new Position(3311, 3183, 0)}), new BotRoute(new Position[]{new Position(3312, 3183, 0)})};

    public AlKharidGeneralStoreBotTask(int n) {
        super(routeStartPosition, taskRouteSegments, 1, false, 1);
        n = 2;
        AlKharidGeneralStoreBotTask alKharidGeneralStoreBotTask = this;
    ...
    public final int getShopId() {
        NpcDefinition npcDefinition = NpcDefinition.forId(524);
    ...
    public final void configureTaskInteractionTargets(Player player) {
        ...
        player.botInteractionTargetIds.add(524);
        player.botInteractionTargetIds.add(525);
    }
    ...
    public final void startCustomTaskAction(Player object) {
        World.getTaskScheduler().schedule(new AlKharidGeneralStoreTradeTickTask(this, 2, (Player)object));
    }
