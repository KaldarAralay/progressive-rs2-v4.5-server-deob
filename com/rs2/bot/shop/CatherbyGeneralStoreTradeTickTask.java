...
final class CatherbyGeneralStoreTradeTickTask
extends TickTask {
    private final /* synthetic */ Player player;

    CatherbyGeneralStoreTradeTickTask(CatherbyGeneralStoreBotTask catherbyGeneralStoreBotTask, int n, Player player) {
        this.player = player;
        super(2);
    }
