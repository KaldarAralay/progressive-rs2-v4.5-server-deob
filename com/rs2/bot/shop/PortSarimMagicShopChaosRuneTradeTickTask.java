...
final class PortSarimMagicShopChaosRuneTradeTickTask
extends TickTask {
    private final /* synthetic */ Player player;
    private final /* synthetic */ ItemStack shopItem;

    PortSarimMagicShopChaosRuneTradeTickTask(PortSarimMagicShopChaosRuneBotTask portSarimMagicShopChaosRuneBotTask, int n, Player player, ItemStack itemStack) {
        this.player = player;
