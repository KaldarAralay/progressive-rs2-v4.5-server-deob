...
final class VarrockSwordShopMithrilLongswordTradeTickTask
extends TickTask {
    private final /* synthetic */ Player player;
    private final /* synthetic */ ItemStack shopItem;

    VarrockSwordShopMithrilLongswordTradeTickTask(VarrockSwordShopMithrilLongswordBotTask varrockSwordShopMithrilLongswordBotTask, int n, Player player, ItemStack itemStack) {
        this.player = player;
