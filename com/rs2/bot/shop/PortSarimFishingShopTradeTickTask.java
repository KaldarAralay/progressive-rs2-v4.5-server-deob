...
public final class PortSarimFishingShopTradeTickTask
extends TickTask {
    private final /* synthetic */ Player player;
    private final /* synthetic */ ItemStack shopItem;

    public PortSarimFishingShopTradeTickTask(PortSarimFishingShopBotTask portSarimFishingShopBotTask, int n, Player player, ItemStack itemStack) {
        super(2);
        this.player = player;
