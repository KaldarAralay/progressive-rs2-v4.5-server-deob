...
public final class DraynorTreeWoodcuttingBotTask
extends BotTaskDefinition {
    private static Position aa = new Position(3092, 3245, 0);
    private static BotRoute ab = new BotRoute(new Position[]{new Position(3093, 3247, 0), new Position(3099, 3250, 0), new Position(3107, 3251, 0)});

    public DraynorTreeWoodcuttingBotTask(int n) {
        super(aa, ab, 0, false, 3);
        int n2 = 3258;
        DraynorTreeWoodcuttingBotTask draynorTreeWoodcuttingBotTask = this;
        this.targetMaxY = n2;
        n2 = 3238;
        draynorTreeWoodcuttingBotTask = this;
        this.targetMinY = n2;
        n2 = 3098;
        draynorTreeWoodcuttingBotTask = this;
        this.targetMinX = n2;
