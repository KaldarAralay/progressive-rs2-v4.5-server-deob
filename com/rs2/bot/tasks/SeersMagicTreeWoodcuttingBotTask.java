...
public final class SeersMagicTreeWoodcuttingBotTask
extends BotTaskDefinition {
    private static Position aa = new Position(2725, 3493, 0);
    private static BotRoute ab = new BotRoute(new Position[]{new Position(2725, 3486, 0), new Position(2718, 3484, 0), new Position(2718, 3463, 0), new Position(2718, 3456, 0), new Position(2709, 3448, 0), new Position(2707, 3434, 0), new Position(2700, 3427, 0)});

    public SeersMagicTreeWoodcuttingBotTask(int n) {
    ...
    public final ArrayList getRequiredItems(Player player) {
        ...
        arrayList.add(new ItemStack(ItemCombinationHandler.c(player, 8).a(), 1));
        return arrayList;
    }
    ...
    public final void configureTaskInteractionTargets(Player player) {
        ...
        int[] nArray = TreeDefinition.collectObjectIds(new TreeDefinition[]{TreeDefinition.MAGIC});
        int n = nArray.length;
        int n2 = 0;
        while (n2 < n) {
            int n3 = nArray[n2];
    ...
    public final void prepareTaskInventory(Player player) {
        ...
        if (player.getSkillManager().getCurrentLevels()[8] >= 41 && player.getSkillManager().getCurrentLevels()[0] >= 40) {
            ...
            player.getEquipmentManager().getContainer().setItem(3, new ItemStack(GameUtil.h(2) == 0 ? 1349 : 1351));
        }
