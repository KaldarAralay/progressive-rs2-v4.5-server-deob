...
public final class VarrockWestTreeWoodcuttingBotTask
extends BotTaskDefinition {
    private static Position aa = new Position(3185, 3436, 0);
    private static BotRoute ab = new BotRoute(new Position[]{new Position(3182, 3432, 0), new Position(3170, 3428, 0), new Position(3163, 3420, 0)});

    public VarrockWestTreeWoodcuttingBotTask(int n) {
        super(aa, ab, 0, false, 3);
        int n2 = 3424;
        VarrockWestTreeWoodcuttingBotTask varrockWestTreeWoodcuttingBotTask = this;
        this.targetMaxY = n2;
        n2 = 3403;
        varrockWestTreeWoodcuttingBotTask = this;
        this.targetMinY = n2;
        n2 = 3158;
        varrockWestTreeWoodcuttingBotTask = this;
        this.targetMinX = n2;
