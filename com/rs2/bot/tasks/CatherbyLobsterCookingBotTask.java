...
extends BotTaskDefinition {
    ...
    private static BotRoute[] ab = new BotRoute[]{new BotRoute(new Position[]{new Position(2809, 3437, 0), new Position(2816, 3438, 0)}), new BotRoute(new Position[]{new Position(2816, 3439, 0)})};

    public CatherbyLobsterCookingBotTask(int n) {
        super(aa, ab, 0, true, 1);
    }
