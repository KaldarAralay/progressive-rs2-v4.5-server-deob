...
extends BotTaskDefinition {
    ...
    private static BotRoute[] taskRouteSegments = new BotRoute[]{new BotRoute(new Position[]{new Position(3012, 3359, 0), new Position(3008, 3359, 0), new Position(3008, 3345, 0), new Position(3008, 3330, 0), new Position(3008, 3322, 0), new Position(3024, 3318, 0), new Position(3032, 3314, 0)}), new BotRoute(new Position[]{new Position(3032, 3313, 0)})};
