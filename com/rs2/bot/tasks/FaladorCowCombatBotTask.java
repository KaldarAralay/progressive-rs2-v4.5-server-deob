...
public final class FaladorCowCombatBotTask
extends BotTaskDefinition {
    private static Position aa = new Position(3012, 3355, 0);
    private static int[] ab = new int[]{2132};
    private static BotRoute[] ac = new BotRoute[]{new BotRoute(new Position[]{new Position(3012, 3359, 0), new Position(3008, 3359, 0), new Position(3008, 3345, 0), new Position(3008, 3330, 0), new Position(3008, 3322, 0), new Position(3024, 3318, 0), new Position(3032, 3314, 0)}), new BotRoute(new Position[]{new Position(3032, 3313, 0)})};

    public FaladorCowCombatBotTask(int n) {
        super(aa, ac, 1, false, 4);
        boolean bl = true;
        FaladorCowCombatBotTask faladorCowCombatBotTask = this;
        this.combatTask = true;
        int[] nArray = ab;
        faladorCowCombatBotTask = this;
    ...
    public final void c(Player player, boolean bl) {
        int n;
        int n2 = n = ServerSettings.cacheVersion > 321 ? 7050 : 1553;
