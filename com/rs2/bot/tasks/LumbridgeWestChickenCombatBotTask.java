...
public final class LumbridgeWestChickenCombatBotTask
extends BotTaskDefinition {
    ...
    private static BotRoute[] taskRouteSegments = new BotRoute[]{new BotRoute(new Position[]{new Position(3273, 3167, 0), new Position(3275, 3176, 0), new Position(3270, 3178, 0), new Position(3269, 3193, 0), new Position(3269, 3212, 0), new Position(3268, 3228, 0)}), new BotRoute(new Position[]{new Position(3267, 3228, 0), new Position(3258, 3247, 0), new Position(3252, 3254, 0), new Position(3240, 3261, 0), new Position(3229, 3262, 0), new Position(3213, 3277, 0), new Position(3198, 3279, 0), new Position(3189, 3280, 0)}), new BotRoute(new Position[]{new Position(3189, 3279, 0)})};

    public LumbridgeWestChickenCombatBotTask(int n) {
        super(routeStartPosition, taskRouteSegments, 1, false, 1);
        boolean bl = true;
        LumbridgeWestChickenCombatBotTask lumbridgeWestChickenCombatBotTask = this;
        this.combatTask = true;
        int[] nArray = ignoredLootItemIds;
        lumbridgeWestChickenCombatBotTask = this;
    ...
    public final void advanceTaskRouteSegment(Player player, boolean bl) {
        int n;
        int n2 = n = !GameplayHelper.isObjectDefinitionIdValid(12987) ? 1553 : 12987;
