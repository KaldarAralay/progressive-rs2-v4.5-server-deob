...
public final class VarrockSteelDaggerSmithingBotTask
extends BotTaskDefinition {
    private static Position routeStartPosition = new Position(3185, 3436, 0);
    private static BotRoute[] taskRouteSegments = new BotRoute[]{new BotRoute(new Position[]{new Position(3182, 3432, 0), new Position(3187, 3428, 0)}), new BotRoute(new Position[]{new Position(3187, 3427, 0)})};

    public VarrockSteelDaggerSmithingBotTask(int n) {
    ...
    public final void prepareTaskInventory(Player player) {
        ...
        player.botSmithingProductItemId = 1207;
        player.getBankContainer().addToTab(new ItemStack(player.botTaskItemId, 5000), 0);
        ItemStack[] itemStackArray = new ItemStack[]{new ItemStack(2347), new ItemStack(player.botTaskItemId, 27)};
