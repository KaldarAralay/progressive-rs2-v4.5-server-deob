...
public final class SeersYewWoodcuttingBotTask
extends BotTaskDefinition {
    private static Position aa = new Position(2725, 3493, 0);
    private static BotRoute ab = new BotRoute(new Position[]{new Position(2725, 3486, 0), new Position(2718, 3484, 0), new Position(2718, 3463, 0)});

    public SeersYewWoodcuttingBotTask(int n) {
