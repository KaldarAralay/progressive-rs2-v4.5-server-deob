...
public final class AlKharidWarriorCombatBotTask
extends BotTaskDefinition {
    private static Position routeStartPosition = new Position(3269, 3167, 0);
    private static BotRoute taskRoute = new BotRoute(new Position[]{new Position(3273, 3167, 0), new Position(3280, 3179, 0), new Position(3293, 3179, 0)});

    public AlKharidWarriorCombatBotTask(int n) {
        super(routeStartPosition, taskRoute, 1, false, 3);
        n = 1;
        AlKharidWarriorCombatBotTask alKharidWarriorCombatBotTask = this;
        this.combatTask = true;
    }

    @Override
    public final boolean meetsUnlockRequirements(Player player) {
        return player.getCombatLevel() > 6;
    }
    ...
    public final void configureTaskInteractionTargets(Player player) {
        ...
        player.botInteractionTargetIds.add(18);
    }
