...
public final class CacheRevisionInfo {
    ...
    public static CacheRevisionInfo a(int n) {
        CacheRevisionInfo[] cacheRevisionInfoArray = d;
        int n2 = d.length;
        int n3 = 0;
        while (n3 < n2) {
            CacheRevisionInfo cacheRevisionInfo = cacheRevisionInfoArray[n3];
            if (cacheRevisionInfo.c == n) {
