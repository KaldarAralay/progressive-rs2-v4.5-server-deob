...
public final class AbyssManager {
    private static int[] a = new int[]{5509, 5510, 5512, 5514};
    ...
    public static void a(Player object, Npc npc) {
        if (AbyssManager.a((Player)object) == -1) {
            return;
        }
        if ((npc.getDefinition().getName().equalsIgnoreCase("leech") || npc.getDefinition().getName().equalsIgnoreCase("guardian") || npc.getDefinition().getName().equalsIgnoreCase("walker")) && GameUtil.g(100) == 5) {
            object = new GroundItem(new ItemStack(AbyssManager.a((Player)object)), (Entity)object, npc.getPosition());
    ...
    public static boolean a(Player player, int n, int n2, int n3) {
        switch (n) {
            case 7145: {
                AbyssManager.c(player, n2, n3, 3024, 4833);
                return true;
            }
            case 7151: {
                AbyssManager.c(player, n2, n3, 3053, 4830);
                return true;
            }
            case 7143: {
                AbyssManager.a(player, n2, n3, 3030, 4821);
                return true;
            }
            case 7153: {
                AbyssManager.a(player, n2, n3, 3048, 4822);
                return true;
            }
            case 7152: {
                AbyssManager.b(player, n2, n3, 3050, 4824);
                return true;
            }
            case 7144: {
                AbyssManager.b(player, n2, n3, 3028, 4824);
                return true;
            }
            case 7149: {
                AbyssManager.e(player, n2, n3, 3048, 4842);
                return true;
            }
            case 7147: {
                AbyssManager.e(player, n2, n3, 3031, 4842);
                return true;
            }
            case 7146: {
                AbyssManager.d(player, n2, n3, 3029, 4841);
                return true;
            }
            case 7150: {
                AbyssManager.d(player, n2, n3, 3051, 4838);
                return true;
            }
            case 7148: {
    ...
    private static void a(Player player, int n, int n2, int n3, int n4, String string, int n5, int n6, int n7, boolean bl) {
        ...
        AbyssManager.d(player2, string2);
        player.n(true);
    ...
    public static void a(Player player, String object) {
    ...
    private static void d(Player player, String object) {
        if (object == "mineRock") {
            player.getUpdateState().setAnimation(ItemCombinationHandler.a(player, 14).d());
            return;
        }
        if (object == "chopTendrils") {
            player.getUpdateState().setAnimation(ItemCombinationHandler.a(player, 8).d());
            return;
        }
        if (object == "blockade") {
    ...
    private static void a(Player player, int n, int n2, int n3, int n4) {
        boolean bl = true;
        if (ItemCombinationHandler.a(player, 14) == null) {
            Player player2 = player;
            player2.packetSender.sendGameMessage("You need a pickaxe to mine here.");
            bl = false;
        }
        AbyssManager.a(player, n, n2, n3, n4, "mineRock", 7159, 7160, 2, bl);
    }

    private static void b(Player player, int n, int n2, int n3, int n4) {
        n4 = 1;
        if (ItemCombinationHandler.a(player, 8) == null) {
            Player player2 = player;
            player2.packetSender.sendGameMessage("You need an axe to chop these.");
            n4 = 0;
        }
        AbyssManager.a(player, n, n2, n3, 4824, "chopTendrils", -1, 7163, 1, n4 != 0);
    }

    private static void c(Player player, int n, int n2, int n3, int n4) {
        boolean bl = true;
        ...
        AbyssManager.a(player, n, n2, n3, n4, "blockade", -1, 7167, 1, bl);
    }

    private static void d(Player player, int n, int n2, int n3, int n4) {
        AbyssManager.a(player, n, n2, n3, n4, "distractEye", 7169, 7170, 2, true);
    }

    private static void e(Player player, int n, int n2, int n3, int n4) {
        AbyssManager.a(player, n, n2, n3, 4842, "crossGap", -1, -1, 0, true);
    }

    public static void b(Player player, Npc npc) {
    ...
    static /* synthetic */ void b(Player player, String string) {
        AbyssManager.d(player, string);
    }

    static /* synthetic */ void c(Player player, String string) {
        Player player2;
        if (string == "mineRock") {
            player2 = player;
    ...
    static /* synthetic */ void a(Player player, int n, int n2) {
        player.n(true);
