...
final class ArmadylGodswordSpecialDefinition
extends SpecialAttackDefinition {
    ArmadylGodswordSpecialDefinition(int n2, String ... stringArray) {
    }

    @Override
    public final WeaponCombatAttack createAttack(Player object, Entity entity, WeaponProfile weaponProfile) {
        object = new ArmadylGodswordSpecialAttack(this, (Player)object, entity, weaponProfile);
        return object;
    }
}
