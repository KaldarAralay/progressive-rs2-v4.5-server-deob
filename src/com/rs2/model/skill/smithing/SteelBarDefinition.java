...
final class SteelBarDefinition
extends SmithingBarDefinition {
    SteelBarDefinition(int n, double d, int n2, SmithableItemDefinition[] smithableItemDefinitionArray) {
        super(30, 37.5, 2353, smithableItemDefinitionArray);
    }
}
