...
final class MonkeyArcherCombatDefinition
extends NpcCombatDefinition {
    MonkeyArcherCombatDefinition() {
    }

    @Override
    public final CombatAttack[] createAttacks(Entity entity, Entity entity2) {
        return new CombatAttack[]{BaseCombatAttack.a(entity, entity2, CombatType.RANGED, AttackXpMode.LONGRANGE, 20, 4, 1394, new GraphicEffect(-1, 0), new GraphicEffect(-1, 0), 9, ProjectileTiming.a)};
    }
}
