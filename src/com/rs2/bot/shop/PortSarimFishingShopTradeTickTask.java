...
final class PortSarimFishingShopTradeTickTask
extends TickTask {
    private final /* synthetic */ Player player;
    private final /* synthetic */ ItemStack shopItem;

    PortSarimFishingShopTradeTickTask(PortSarimFishingShopBotTask portSarimFishingShopBotTask, int n, Player player, ItemStack itemStack) {
        this.player = player;
