...
final class CatherbyArcheryShopShortbowTradeTickTask
extends TickTask {
    private final /* synthetic */ Player player;
    private final /* synthetic */ ItemStack shopItem;

    CatherbyArcheryShopShortbowTradeTickTask(CatherbyArcheryShopShortbowBotTask catherbyArcheryShopShortbowBotTask, int n, Player player, ItemStack itemStack) {
        this.player = player;
