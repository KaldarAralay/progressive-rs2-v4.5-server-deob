...
extends BotTaskDefinition {
    ...
    private static BotRoute[] ab = new BotRoute[]{new BotRoute(new Position[]{new Position(3273, 3167, 0), new Position(3280, 3185, 0)}), new BotRoute(new Position[]{new Position(3279, 3185, 0)})};

    public AlKharidSteelSmeltingBotTask(int n) {
