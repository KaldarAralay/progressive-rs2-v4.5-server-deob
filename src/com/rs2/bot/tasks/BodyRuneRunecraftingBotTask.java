...
extends BotTaskDefinition {
    ...
    public BodyRuneRunecraftingBotTask(int n) {
    ...
    public final ArrayList getRequiredItems(Player player) {
        ...
        if (player.aq(5533) && ItemDefinition.isDefined(5533)) {
    ...
    public final void prepareTaskInventory(Player player) {
        ...
        if (GameUtil.h(2) == 0 || !ItemDefinition.isDefined(5533)) {
    ...
    public final void b(Player player, int n) {
        ...
        if (player.botPathSegmentIndex == ab.length - 2 && player.botPathWaypointIndex == 0 && n != 12085) {
            ArrayList<Integer> arrayList = new ArrayList<Integer>();
            arrayList.add(2470);
            player.interactWithBotObjectTargets(arrayList);
            player.dm = true;
