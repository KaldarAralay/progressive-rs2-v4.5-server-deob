...
extends BotTaskDefinition {
    ...
    public final boolean meetsUnlockRequirements(Player player) {
        ...
        return player.getSkillManager().getCurrentLevels()[8] >= 45;
    }
    ...
    public final void configureTaskInteractionTargets(Player player) {
        ...
        int[] nArray = TreeDefinition.collectObjectIds(new TreeDefinition[]{TreeDefinition.MAPLE});
        int n = nArray.length;
        int n2 = 0;
        while (n2 < n) {
            int n3 = nArray[n2];
