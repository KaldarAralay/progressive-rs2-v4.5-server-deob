...
public final class VarrockEastTreeWoodcuttingBotTask
extends BotTaskDefinition {
    private static Position aa = new Position(3254, 3420, 0);
    private static BotRoute ab = new BotRoute(new Position[]{new Position(3254, 3428, 0), new Position(3265, 3429, 0), new Position(3273, 3429, 0), new Position(3275, 3445, 0)});

    public VarrockEastTreeWoodcuttingBotTask(int n) {
        super(aa, ab, 0, false, 3);
        int n2 = 3456;
        VarrockEastTreeWoodcuttingBotTask varrockEastTreeWoodcuttingBotTask = this;
        this.targetMaxY = n2;
        n2 = 3439;
        varrockEastTreeWoodcuttingBotTask = this;
        this.targetMinY = n2;
        n2 = 3274;
        varrockEastTreeWoodcuttingBotTask = this;
        this.targetMinX = n2;
