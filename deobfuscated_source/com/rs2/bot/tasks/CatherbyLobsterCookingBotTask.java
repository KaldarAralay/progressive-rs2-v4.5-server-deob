...
public final class CatherbyLobsterCookingBotTask
extends BotTaskDefinition {
    private static Position routeStartPosition = new Position(2809, 3441, 0);
    private static BotRoute[] taskRouteSegments = new BotRoute[]{new BotRoute(new Position[]{new Position(2809, 3437, 0), new Position(2816, 3438, 0)}), new BotRoute(new Position[]{new Position(2816, 3439, 0)})};

    public CatherbyLobsterCookingBotTask(int n) {
        super(routeStartPosition, taskRouteSegments, 0, true, 1);
    }
    ...
    public final void prepareTaskCombatLoadout(Player player) {
        ...
        BotCombatHelper.setBotSkillLevel(player, 7, n);
