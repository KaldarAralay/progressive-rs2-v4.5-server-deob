...
extends BotTaskDefinition {
    ...
    private static BotRoute taskRoute = new BotRoute(new Position[]{new Position(2725, 3486, 0), new Position(2718, 3484, 0), new Position(2718, 3463, 0), new Position(2718, 3456, 0), new Position(2709, 3448, 0), new Position(2707, 3434, 0), new Position(2700, 3427, 0)});
    ...
    public final void prepareTaskCombatLoadout(Player player) {
        ...
        if ((n = n - n / 5 + GameUtil.randomInt(n2)) < 75) {
            n = 75;
        }
