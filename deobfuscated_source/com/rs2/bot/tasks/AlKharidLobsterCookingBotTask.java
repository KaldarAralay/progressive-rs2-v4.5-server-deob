...
public final class AlKharidLobsterCookingBotTask
extends BotTaskDefinition {
    private static Position routeStartPosition = new Position(3269, 3167, 0);
    private static BotRoute[] taskRouteSegments = new BotRoute[]{new BotRoute(new Position[]{new Position(3273, 3167, 0), new Position(3276, 3180, 0)}), new BotRoute(new Position[]{new Position(3275, 3180, 0)})};

    public AlKharidLobsterCookingBotTask(int n) {
