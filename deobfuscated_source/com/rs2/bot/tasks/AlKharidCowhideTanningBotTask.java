...
extends BotTaskDefinition {
    ...
    private static BotRoute[] taskRouteSegments = new BotRoute[]{new BotRoute(new Position[]{new Position(3273, 3167, 0), new Position(3280, 3183, 0), new Position(3280, 3189, 0), new Position(3278, 3191, 0)}), new BotRoute(new Position[]{new Position(3277, 3191, 0)})};
