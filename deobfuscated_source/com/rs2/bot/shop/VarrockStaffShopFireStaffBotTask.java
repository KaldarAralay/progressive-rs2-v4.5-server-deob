...
import com.rs2.bot.shop.VarrockStaffShopFireStaffTradeTickTask;
...
public final class VarrockStaffShopFireStaffBotTask
extends BotTaskDefinition {
    private static Position routeStartPosition = new Position(3185, 3436, 0);
    private static BotRoute[] taskRouteSegments = new BotRoute[]{new BotRoute(new Position[]{new Position(3182, 3432, 0), new Position(3197, 3431, 0), new Position(3205, 3430, 0), new Position(3205, 3432, 0)}), new BotRoute(new Position[]{new Position(3204, 3432, 0)})};

    public VarrockStaffShopFireStaffBotTask(int n) {
        super(routeStartPosition, taskRouteSegments, 1, false, 1);
        n = 2;
        VarrockStaffShopFireStaffBotTask varrockStaffShopFireStaffBotTask = this;
    ...
    public final int getShopId() {
        NpcDefinition npcDefinition = NpcDefinition.forId(546);
    ...
    public final void configureTaskInteractionTargets(Player player) {
        ...
        player.botInteractionTargetIds.add(546);
    }
    ...
    public final void startCustomTaskAction(Player object) {
        ...
        World.getTaskScheduler().schedule(new VarrockStaffShopFireStaffTradeTickTask(this, 2, (Player)object, itemStack));
    }
