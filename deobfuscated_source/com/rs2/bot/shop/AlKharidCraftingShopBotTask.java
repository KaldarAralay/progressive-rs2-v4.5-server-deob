...
import com.rs2.bot.shop.AlKharidCraftingShopTradeTickTask;
...
public final class AlKharidCraftingShopBotTask
extends BotTaskDefinition {
    private static Position routeStartPosition = new Position(3269, 3167, 0);
    private static BotRoute[] taskRouteSegments = new BotRoute[]{new BotRoute(new Position[]{new Position(3273, 3167, 0), new Position(3280, 3179, 0), new Position(3293, 3179, 0), new Position(3303, 3184, 0), new Position(3311, 3190, 0), new Position(3317, 3193, 0)}), new BotRoute(new Position[]{new Position(3318, 3193, 0)})};

    public AlKharidCraftingShopBotTask(int n) {
        super(routeStartPosition, taskRouteSegments, 1, false, 1);
        n = 2;
        AlKharidCraftingShopBotTask alKharidCraftingShopBotTask = this;
    ...
    public final int getShopId() {
        NpcDefinition npcDefinition = NpcDefinition.forId(545);
    ...
    public final void configureTaskInteractionTargets(Player player) {
        ...
        player.botInteractionTargetIds.add(545);
    }
    ...
    public final void prepareTaskInventory(Player player) {
        ...
        player.botTaskItemId = 1733;
        player.botShopItemAmount = 1;
        player.botShopBuyMode = GameUtil.randomInt(2);
        ItemStack[] itemStackArray = player.botShopBuyMode == 1 ? new ItemStack[]{new ItemStack(995, 2000)} : new ItemStack[]{new ItemStack(player.botTaskItemId, player.botShopItemAmount)};
    ...
    public final void startCustomTaskAction(Player object) {
        ...
        World.getTaskScheduler().schedule(new AlKharidCraftingShopTradeTickTask(this, 2, (Player)object, itemStack));
    }
