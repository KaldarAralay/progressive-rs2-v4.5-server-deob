...
public final class PortSarimMagicShopChaosRuneTradeTickTask
extends TickTask {
    private final /* synthetic */ Player player;
    private final /* synthetic */ ItemStack shopItem;

    public PortSarimMagicShopChaosRuneTradeTickTask(PortSarimMagicShopChaosRuneBotTask portSarimMagicShopChaosRuneBotTask, int n, Player player, ItemStack itemStack) {
        super(2);
        this.player = player;
