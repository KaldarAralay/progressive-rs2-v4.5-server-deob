...
import com.rs2.bot.shop.ArdougnePlatebodyShopTradeTickTask;
...
public final class ArdougnePlatebodyShopBotTask
extends BotTaskDefinition {
    private static Position routeStartPosition = new Position(2655, 3283, 0);
    private static BotRoute[] taskRouteSegments = new BotRoute[]{new BotRoute(new Position[]{new Position(2644, 3284, 0), new Position(2642, 3295, 0), new Position(2639, 3302, 0), new Position(2643, 3306, 0), new Position(2652, 3306, 0), new Position(2654, 3297, 0)}), new BotRoute(new Position[]{new Position(2654, 3295, 0)})};

    public ArdougnePlatebodyShopBotTask(int n) {
        super(routeStartPosition, taskRouteSegments, 1, true, 1);
        n = 2;
        ArdougnePlatebodyShopBotTask ardougnePlatebodyShopBotTask = this;
    ...
    public final int getShopId() {
        NpcDefinition npcDefinition = NpcDefinition.forId(589);
    ...
    public final void configureTaskInteractionTargets(Player player) {
        ...
        player.botInteractionTargetIds.add(589);
    }
    ...
    public final void startCustomTaskAction(Player object) {
        ...
        World.getTaskScheduler().schedule(new ArdougnePlatebodyShopTradeTickTask(this, 2, (Player)object, itemStack));
    }
