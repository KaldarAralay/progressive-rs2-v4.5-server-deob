...
import com.rs2.bot.shop.AlKharidScimitarShopTradeTickTask;
...
public final class AlKharidScimitarShopBotTask
extends BotTaskDefinition {
    private static Position routeStartPosition = new Position(3269, 3167, 0);
    private static BotRoute[] taskRouteSegments = new BotRoute[]{new BotRoute(new Position[]{new Position(3273, 3167, 0), new Position(3280, 3179, 0), new Position(3287, 3186, 0)}), new BotRoute(new Position[]{new Position(3287, 3187, 0)})};

    public AlKharidScimitarShopBotTask(int n) {
        super(routeStartPosition, taskRouteSegments, 1, false, 1);
        n = 2;
        AlKharidScimitarShopBotTask alKharidScimitarShopBotTask = this;
    ...
    public final int getShopId() {
        NpcDefinition npcDefinition = NpcDefinition.forId(541);
    ...
    public final void configureTaskInteractionTargets(Player player) {
        ...
        player.botInteractionTargetIds.add(541);
    }
    ...
    public final void startCustomTaskAction(Player object) {
        ...
        World.getTaskScheduler().schedule(new AlKharidScimitarShopTradeTickTask(this, 2, (Player)object, itemStack));
    }
