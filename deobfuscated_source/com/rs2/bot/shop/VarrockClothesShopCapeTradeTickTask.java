...
public final class VarrockClothesShopCapeTradeTickTask
extends TickTask {
    private final /* synthetic */ Player player;
    private final /* synthetic */ ItemStack shopItem;

    public VarrockClothesShopCapeTradeTickTask(VarrockClothesShopCapeBotTask varrockClothesShopCapeBotTask, int n, Player player, ItemStack itemStack) {
        super(2);
        this.player = player;
