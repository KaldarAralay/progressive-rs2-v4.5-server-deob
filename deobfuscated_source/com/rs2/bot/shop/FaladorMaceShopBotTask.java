...
import com.rs2.bot.shop.FaladorMaceShopTradeTickTask;
...
extends BotTaskDefinition {
    ...
    public final int getShopId() {
        NpcDefinition npcDefinition = NpcDefinition.forId(580);
    ...
    public final void configureTaskInteractionTargets(Player player) {
        ...
        player.botInteractionTargetIds.add(580);
    }
    ...
    public final void startCustomTaskAction(Player object) {
        ...
        World.getTaskScheduler().schedule(new FaladorMaceShopTradeTickTask(this, 2, (Player)object, itemStack));
    }
