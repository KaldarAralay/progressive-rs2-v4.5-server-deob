...
public final class VarrockSwordShopMithrilLongswordTradeTickTask
extends TickTask {
    private final /* synthetic */ Player player;
    private final /* synthetic */ ItemStack shopItem;

    public VarrockSwordShopMithrilLongswordTradeTickTask(VarrockSwordShopMithrilLongswordBotTask varrockSwordShopMithrilLongswordBotTask, int n, Player player, ItemStack itemStack) {
        super(2);
        this.player = player;
