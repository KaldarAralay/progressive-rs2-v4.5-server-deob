...
public final class CatherbyArcheryShopShortbowTradeTickTask
extends TickTask {
    private final /* synthetic */ Player player;
    private final /* synthetic */ ItemStack shopItem;

    public CatherbyArcheryShopShortbowTradeTickTask(CatherbyArcheryShopShortbowBotTask catherbyArcheryShopShortbowBotTask, int n, Player player, ItemStack itemStack) {
        super(2);
        this.player = player;
