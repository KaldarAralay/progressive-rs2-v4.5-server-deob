...
import com.rs2.bot.shop.CatherbyArcheryShopShortbowTradeTickTask;
...
public final class CatherbyArcheryShopShortbowBotTask
extends BotTaskDefinition {
    private static Position routeStartPosition = new Position(2809, 3441, 0);
    private static BotRoute[] taskRouteSegments = new BotRoute[]{new BotRoute(new Position[]{new Position(2809, 3437, 0), new Position(2820, 3437, 0), new Position(2822, 3440, 0)}), new BotRoute(new Position[]{new Position(2822, 3441, 0)})};

    public CatherbyArcheryShopShortbowBotTask(int n) {
        super(routeStartPosition, taskRouteSegments, 1, true, 1);
        n = 2;
        CatherbyArcheryShopShortbowBotTask catherbyArcheryShopShortbowBotTask = this;
    ...
    public final int getShopId() {
        NpcDefinition npcDefinition = NpcDefinition.forId(575);
    ...
    public final void configureTaskInteractionTargets(Player player) {
        ...
        player.botInteractionTargetIds.add(575);
    }
    ...
    public final void startCustomTaskAction(Player object) {
        ...
        World.getTaskScheduler().schedule(new CatherbyArcheryShopShortbowTradeTickTask(this, 2, (Player)object, itemStack));
    }
