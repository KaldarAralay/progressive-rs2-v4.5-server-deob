...
import com.rs2.bot.shop.VarrockArcheryShopSteelArrowTradeTickTask;
...
public final class VarrockArcheryShopSteelArrowBotTask
extends BotTaskDefinition {
    private static Position routeStartPosition = new Position(3253, 3420, 0);
    private static BotRoute[] taskRouteSegments = new BotRoute[]{new BotRoute(new Position[]{new Position(3253, 3428, 0), new Position(3239, 3428, 0), new Position(3233, 3428, 0)}), new BotRoute(new Position[]{new Position(3233, 3427, 0)})};

    public VarrockArcheryShopSteelArrowBotTask(int n) {
        super(routeStartPosition, taskRouteSegments, 1, false, 1);
        n = 2;
        VarrockArcheryShopSteelArrowBotTask varrockArcheryShopSteelArrowBotTask = this;
    ...
    public final int getShopId() {
        NpcDefinition npcDefinition = NpcDefinition.forId(550);
    ...
    public final void configureTaskInteractionTargets(Player player) {
        ...
        player.botInteractionTargetIds.add(550);
    }
    ...
    public final void prepareTaskInventory(Player player) {
        ...
        player.botTaskItemId = 886;
        player.botShopItemAmount = 20;
    ...
    public final void startCustomTaskAction(Player object) {
        ...
        World.getTaskScheduler().schedule(new VarrockArcheryShopSteelArrowTradeTickTask(this, 2, (Player)object, itemStack));
    }
