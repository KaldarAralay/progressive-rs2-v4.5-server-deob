...
import com.rs2.bot.shop.VarrockRuneShopChaosRuneTradeTickTask;
...
public final class VarrockRuneShopChaosRuneBotTask
extends BotTaskDefinition {
    private static Position routeStartPosition = new Position(3254, 3420, 0);
    private static BotRoute[] taskRouteSegments = new BotRoute[]{new BotRoute(new Position[]{new Position(3254, 3428, 0), new Position(3260, 3425, 0), new Position(3260, 3414, 0), new Position(3257, 3400, 0), new Position(3253, 3398, 0)}), new BotRoute(new Position[]{new Position(3253, 3399, 0)})};

    public VarrockRuneShopChaosRuneBotTask(int n) {
        super(routeStartPosition, taskRouteSegments, 1, false, 1);
        n = 2;
        VarrockRuneShopChaosRuneBotTask varrockRuneShopChaosRuneBotTask = this;
    ...
    public final int getShopId() {
        NpcDefinition npcDefinition = NpcDefinition.forId(553);
    ...
    public final void configureTaskInteractionTargets(Player player) {
        ...
        player.botInteractionTargetIds.add(553);
    }
    ...
    public final void prepareTaskInventory(Player player) {
        ...
        player.botTaskItemId = 562;
        player.botShopItemAmount = 50;
    ...
    public final void startCustomTaskAction(Player object) {
        ...
        World.getTaskScheduler().schedule(new VarrockRuneShopChaosRuneTradeTickTask(this, 2, (Player)object, itemStack));
    }
