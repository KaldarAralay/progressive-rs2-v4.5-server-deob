...
import com.rs2.bot.shop.BarbarianVillageHelmetShopTradeTickTask;
...
public final class BarbarianVillageHelmetShopBotTask
extends BotTaskDefinition {
    private static Position routeStartPosition = new Position(3094, 3489, 0);
    private static BotRoute[] taskRouteSegments = new BotRoute[]{new BotRoute(new Position[]{new Position(3090, 3490, 0), new Position(3081, 3483, 0), new Position(3080, 3467, 0), new Position(3086, 3463, 0), new Position(3086, 3452, 0), new Position(3086, 3440, 0), new Position(3083, 3434, 0), new Position(3076, 3426, 0)}), new BotRoute(new Position[]{new Position(3076, 3427, 0)})};

    public BarbarianVillageHelmetShopBotTask(int n) {
        super(routeStartPosition, taskRouteSegments, 1, false, 1);
        n = 2;
        BarbarianVillageHelmetShopBotTask barbarianVillageHelmetShopBotTask = this;
    ...
    public final int getShopId() {
        NpcDefinition npcDefinition = NpcDefinition.forId(538);
    ...
    public final void configureTaskInteractionTargets(Player player) {
        ...
        player.botInteractionTargetIds.add(538);
    }
    ...
    public final void prepareTaskInventory(Player player) {
        ...
        player.botTaskItemId = 1137;
        player.botShopItemAmount = 1;
        player.botShopBuyMode = GameUtil.randomInt(2);
        ItemStack[] itemStackArray = player.botShopBuyMode == 1 ? new ItemStack[]{new ItemStack(995, 200)} : new ItemStack[]{new ItemStack(player.botTaskItemId, player.botShopItemAmount)};
    ...
    public final void startCustomTaskAction(Player object) {
        ...
        World.getTaskScheduler().schedule(new BarbarianVillageHelmetShopTradeTickTask(this, 2, (Player)object, itemStack));
    }
    ...
    public final void startWalkToTask(Player player) {
        int n = !GameplayHelper.isObjectDefinitionIdValid(11616) ? 1530 : 11616;
    ...
    public final void continueWalkToTask(Player player, int n) {
        int n2 = !GameplayHelper.isObjectDefinitionIdValid(11616) ? 1530 : 11616;
        player.setAutoRetaliate(true);
    ...
    public final void advanceTaskRouteSegment(Player player, boolean bl) {
        int n;
        int n2 = n = !GameplayHelper.isObjectDefinitionIdValid(11616) ? 1530 : 11616;
