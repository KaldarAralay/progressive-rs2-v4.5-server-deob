...
import com.rs2.bot.shop.VarrockClothesShopCapeTradeTickTask;
...
public final class VarrockClothesShopCapeBotTask
extends BotTaskDefinition {
    private static Position routeStartPosition = new Position(3185, 3436, 0);
    private static BotRoute[] taskRouteSegments = new BotRoute[]{new BotRoute(new Position[]{new Position(3182, 3432, 0), new Position(3197, 3431, 0), new Position(3205, 3428, 0), new Position(3208, 3420, 0)}), new BotRoute(new Position[]{new Position(3208, 3418, 0)})};

    public VarrockClothesShopCapeBotTask(int n) {
        super(routeStartPosition, taskRouteSegments, 1, false, 1);
        n = 2;
        VarrockClothesShopCapeBotTask varrockClothesShopCapeBotTask = this;
    ...
    public final int getShopId() {
        NpcDefinition npcDefinition = NpcDefinition.forId(548);
    ...
    public final void configureTaskInteractionTargets(Player player) {
        ...
        player.botInteractionTargetIds.add(548);
    }
    ...
    public final void startCustomTaskAction(Player object) {
        ...
        World.getTaskScheduler().schedule(new VarrockClothesShopCapeTradeTickTask(this, 2, (Player)object, itemStack));
    }
