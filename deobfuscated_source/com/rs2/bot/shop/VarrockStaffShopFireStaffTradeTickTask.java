...
extends TickTask {
    ...
    public VarrockStaffShopFireStaffTradeTickTask(VarrockStaffShopFireStaffBotTask varrockStaffShopFireStaffBotTask, int n, Player player, ItemStack itemStack) {
        super(2);
        this.player = player;
