...
import com.rs2.bot.shop.AlKharidLegsShopTradeTickTask;
...
public final class AlKharidLegsShopBotTask
extends BotTaskDefinition {
    private static Position routeStartPosition = new Position(3269, 3167, 0);
    private static BotRoute[] taskRouteSegments = new BotRoute[]{new BotRoute(new Position[]{new Position(3273, 3167, 0), new Position(3280, 3179, 0), new Position(3293, 3179, 0), new Position(3313, 3175, 0)}), new BotRoute(new Position[]{new Position(3314, 3175, 0)})};

    public AlKharidLegsShopBotTask(int n) {
        super(routeStartPosition, taskRouteSegments, 1, false, 1);
        n = 2;
        AlKharidLegsShopBotTask alKharidLegsShopBotTask = this;
    ...
    public final int getShopId() {
        NpcDefinition npcDefinition = NpcDefinition.forId(542);
    ...
    public final void configureTaskInteractionTargets(Player player) {
        ...
        player.botInteractionTargetIds.add(542);
    }
    ...
    public final void startCustomTaskAction(Player object) {
        ...
        World.getTaskScheduler().schedule(new AlKharidLegsShopTradeTickTask(this, 2, (Player)object, itemStack));
    }
