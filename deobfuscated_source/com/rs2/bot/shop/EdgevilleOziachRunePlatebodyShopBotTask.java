...
import com.rs2.bot.shop.EdgevilleOziachRunePlatebodyShopTradeTickTask;
...
public final class EdgevilleOziachRunePlatebodyShopBotTask
extends BotTaskDefinition {
    private static Position routeStartPosition = new Position(3096, 3494, 0);
    private static BotRoute[] taskRouteSegments = new BotRoute[]{new BotRoute(new Position[]{new Position(3092, 3500, 0), new Position(3080, 3502, 0), new Position(3075, 3506, 0), new Position(3070, 3514, 0)}), new BotRoute(new Position[]{new Position(3070, 3515, 0)})};

    public EdgevilleOziachRunePlatebodyShopBotTask(int n) {
        super(routeStartPosition, taskRouteSegments, 1, false, 1);
        n = 2;
        EdgevilleOziachRunePlatebodyShopBotTask edgevilleOziachRunePlatebodyShopBotTask = this;
    ...
    public final int getShopId() {
        NpcDefinition npcDefinition = NpcDefinition.forId(747);
    ...
    public final void configureTaskInteractionTargets(Player player) {
        ...
        player.botInteractionTargetIds.add(747);
    }
    ...
    public final void prepareTaskInventory(Player player) {
        ...
        player.botTaskItemId = 1127;
        player.botShopItemAmount = 1;
        player.botShopBuyMode = GameUtil.randomInt(2);
        ItemStack[] itemStackArray = player.botShopBuyMode == 1 ? new ItemStack[]{new ItemStack(995, 70000)} : new ItemStack[]{new ItemStack(player.botTaskItemId, player.botShopItemAmount)};
    ...
    public final void startCustomTaskAction(Player object) {
        ...
        World.getTaskScheduler().schedule(new EdgevilleOziachRunePlatebodyShopTradeTickTask(this, 2, (Player)object, itemStack));
    }
