...
public final class InfernalMageCombatDefinition
extends NpcCombatDefinition {
    public InfernalMageCombatDefinition() {
    }

    @Override
    public final CombatAttack[] createAttacks(Entity entity, Entity entity2) {
        return new CombatAttack[]{BaseCombatAttack.createMagicAttack(entity, entity2, SpellDefinition.INFERNAL_MAGE_FIRE_BLAST)};
    }
}
