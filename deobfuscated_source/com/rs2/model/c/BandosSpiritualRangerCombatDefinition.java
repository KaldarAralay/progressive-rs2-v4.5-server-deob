...
public final class BandosSpiritualRangerCombatDefinition
extends NpcCombatDefinition {
    public BandosSpiritualRangerCombatDefinition() {
    }

    @Override
    public final CombatAttack[] createAttacks(Entity entity, Entity entity2) {
        return new CombatAttack[]{BaseCombatAttack.createProjectileAttack(entity, entity2, CombatType.RANGED, AttackXpMode.LONGRANGE, 13, 4, 4320, new GraphicEffect(-1, 0), new GraphicEffect(-1, 0), 1206, ProjectileTiming.a)};
    }
}
